...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/otp', { state: { email: formData.email, type: 'register' } });
    } catch (error) {
    ...
    <div className="flex-grow flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 relative z-10">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight mb-2">Create an account</h1>
          <p className="text-slate-500">Join SahaYatri and start your journey.</p>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <a href={oauthGoogleUrl} className="w-full inline-flex justify-center items-center gap-2 py-2.5 px-4 border border-slate-200 rounded-xl bg-white text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
            ...
            <button className="w-full inline-flex justify-center items-center gap-2 py-2.5 px-4 border border-slate-200 rounded-xl bg-white text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
