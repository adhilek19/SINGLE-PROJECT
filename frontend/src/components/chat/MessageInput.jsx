...
const MessageInput = ({
  ...
  return (
    <div className="overflow-x-hidden border-t border-slate-200 bg-white">
      {selectedFile ? (
      ...
      <form onSubmit={handleSubmit} className="flex items-end gap-2 p-3">
        ...
        <button
          ...
          disabled={disabled || mediaUploading}
          className="h-11 shrink-0 rounded-2xl border border-slate-300 px-3 text-slate-700 disabled:opacity-50"
          title="Attach media"
        >
        ...
        <textarea
          ...
          disabled={disabled || mediaUploading}
          className="max-h-32 min-h-[44px] min-w-0 flex-1 resize-none rounded-2xl border border-slate-300 px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 disabled:opacity-60"
        />
        {String(value || '').trim() ? (
          <button
            type="submit"
